...
var secondSliderData = {
  ...
  content: ['lorem23asfdasfasfasfa fas fasf asf asfas f ', 'Вник в asfsagfasgasgfasgasgasения денег с него.', 'Успешно прошел курсы Марафон Пузат Начало asgsagasgasgasта 2017, сделав прибыльные сайты.', 'Про s s ag asgaas sgasga fas sgasgsagasgasg asf отал свою систему создания успешных сайтов.']
};
...
var thirdSlider = new Slider(thirdSliderData);